...
return [
    ...
    'news_letter' => [
        ...
        'description' => 'Get updates on all of our events and be the first to get notified when tickets go on sale.',
        'cta_text' => 'Sign up to our newsletter ↓',
        'email' => 'Email Address',
    ...
    'registration' => [
        'title' => 'Registration',
        'description' => "Don't hesitate, register now and seize this incredible opportunity before it slips away!",
        'fullname' => 'Full Name',
        'country' => 'Country',
