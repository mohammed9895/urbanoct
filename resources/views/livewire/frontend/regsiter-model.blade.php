        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">{{ __('home.activities.register_model_title') }} {{  $activity->title ?? '' }}</h3>
                    <form class="space-y-6" wire:submit="register">
                        <div>
                            <label for="fullname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('home.registration.fullname') }}</label>
                        ...
                        <div>
                            <label for="organization" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('home.registration.organization') }}</label>
                        ...
                        <div>
                            <label for="field" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('home.registration.profession') }}</label>
                        ...
                        <div>
                            <label for="contact_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('home.registration.contact_number') }}</label>
                        ...
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('home.registration.email') }}</label>
                        ...
                        @endif
                        <button type="submit" class="w-full text-white bg-uo-pink hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-uo-pink dark:focus:ring-blue-800">{{ __('home.activities.register_button') }}</button>
                    </form>
                </div>
            </div>
        </div>
