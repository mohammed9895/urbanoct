    ...
    <section id="newsletter" aria-label="Newsletter">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="relative -mx-4 overflow-hidden bg-indigo-50 px-4 py-20 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-3xl md:px-16 xl:px-24 xl:py-36">
                <img alt="" loading="lazy" width="919" height="1351" decoding="async" data-nimg="1" class="absolute left-1/2 top-0 translate-x-[-10%] translate-y-[-45%] lg:translate-x-[-32%] blur-3xl" style="color:transparent" src="http://urbanoct.test/images/hero.svg">
                <div class="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-32 gap-y-14 xl:max-w-none xl:grid-cols-2">
                    ...
                    <form wire:submit="register">
                        ...
                        @if (session()->has('success'))
                            <div class="mt-2 bg-green-300 text-green-700 p-6 rounded-3xl"> {{ session('success') }}</div>
                        @endif
                    </form>
                </div>
            </div>
